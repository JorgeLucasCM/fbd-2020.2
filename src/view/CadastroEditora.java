...
public class CadastroEditora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cadatrodelivro.setText("   Cadastro de Editora    ");
    ...
    private void jBEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEditarActionPerformed
        if( jTFCidade.getText().equals("") || jTFNome.getText().equals("") || jTFCnpj.getText().equals("") ){
            ...
            try {
                if(new EditoraDAO(con).testarEditoraNome(jTFNome.getText())){
                    JOptionPane.showMessageDialog(null, "Nome já utilizado!",null,JOptionPane.ERROR_MESSAGE);
                }else if(new EditoraDAO(con).testarEditoraCNPJ(jTFCnpj.getText())){
                    JOptionPane.showMessageDialog(null, "CNPJ já utilizado!",null,JOptionPane.ERROR_MESSAGE);
                }else{
                    Editora editoraAtual = new Editora();
                    editoraAtual.setNome(jTFNome.getText());
                    editoraAtual.setCidade(jTFCidade.getText());
                    editoraAtual.setCnpj(jTFCnpj.getText());
                    new EditoraDAO(con).inserirEditora(editoraAtual);
    ...
    private void jBCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCancelarActionPerformed
        try {
            ...
            Logger.getLogger(CadastroEditora.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.dispose();
