...
public class CadastroBibliotecario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cadatrodelivro.setText("  Cadastro de Bibliotecario ");
    ...
    private void jBCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCadastrarActionPerformed
        if(jTFNome.getText().equals("") || jTFLogin.getText().equals("") || jTFCpf.getText().equals("   .   .   -  ") || jTFTelefone.getText().equals("(  )      -    ")|| jPSenha.getText().equals("") ||jDDatadeNascimento.getDate() == null ){
            ...
            try {
                if(new BibliotecarioDAO(con).testarBibliotecarioCPF(jTFCpf.getText())){
                    JOptionPane.showMessageDialog(null, "CPF já cadastrado!",null,JOptionPane.ERROR_MESSAGE);
                }else if(new BibliotecarioDAO(con).testarBibliotecarioLogin(jTFLogin.getText())){
                    JOptionPane.showMessageDialog(null, "Login já cadastrado!",null,JOptionPane.ERROR_MESSAGE);
                }else{
                    new BibliotecarioDAO(con).inserirBibliotecario(bibliotecarioAtual);
                    JOptionPane.showMessageDialog(null, "Bibliotecario cadastrado com sucesso!");
                }
            } catch (SQLException ex) {
                Logger.getLogger(CadastroBibliotecario.class.getName()).log(Level.SEVERE, null, ex);
            }
