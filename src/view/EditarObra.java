...
public class EditarObra extends javax.swing.JFrame {
     ...
     */
    public EditarObra() throws SQLException {
        initComponents();
        atualizarCombo();
        definirCombo();
        preencherCampos();
    ...
    private void initComponents() {
        ...
        cadatrodelivro.setText("       Editar Obra");
    ...
    private void jBEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEditarActionPerformed
        if(jTFAutor.getText().equals("") || jTFVolume.getText().equals("") || jTFTitulo.getText().equals("") || jTADescricao.getText().equals("") ){
            ...
            try {
                if(new ObraDAO(con).testarTituloObra(jTFTitulo.getText()) && !(main.obraEditar.getTitulo().equalsIgnoreCase(jTFTitulo.getText()))){
                    JOptionPane.showMessageDialog(null, "Titulo já cadastrado!",null,JOptionPane.ERROR_MESSAGE);
                }else if(new ObraDAO(con).testarIsbnObra(Integer.parseInt(jTFIsbn.getText())) && (main.obraEditar.getIsbn() != Integer.parseInt(jTFIsbn.getText()))){
                    ...
                    obraAtual.setId_obra(main.obraEditar.getId_obra());
                    new ObraDAO(con).alterarObra(obraAtual);
